...
<section className="featured-products">
  ...
  <div className="collection-grid">
    ...
    {/* MEN */}
    <div className="collection-card men" onClick={goToMen}>
      <div className="collection-overlay">
        <h3>Men</h3>
        <p>
          Tailored suits, shirts & traditional wear.<br />
          Crafted to fit your style perfectly.
        </p>
    ...
    {/* WOMEN */}
    <div className="collection-card women" onClick={goToWomen}>
      <div className="collection-overlay">
        <h3>Women</h3>
        <p>
          Elegant dresses & custom designs.<br />
          Made to celebrate your beauty.
        </p>
        <span className="explore-btn">Explore Collection →</span>
      </div>
    </div>
